...
const LoginPage = () => {
    ...
    const onSubmitForm = async (event) => {
        ...
        const url = "https://srinivas-medication-management-api.onrender.com/login";
        const options = {
            method: "POST",
            headers: {
    ...
    return (
        <div className="login-page-container">
            <div className="login-page-responsive">
                ...
                <p className="login-page-suggestion">
                    You don't have an account? <a href="/signup" className="text-link">sign up</a>
                </p>
